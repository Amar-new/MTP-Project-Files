...
Original file is located at
    https://colab.research.google.com/drive/1V2JU2W-o_5CI5-iPUHCyDSMIdb89A63s
"""
...
#         memory = self.relu(self.W(key_attribute))
        ...
        shifted_decoder_input_ids= torch.column_stack([30523 * torch.ones(len(query)), query.cpu()])[:, :-1].type(torch.LongTensor).to(device)
